...
/**
 * 試算表把電話當成數字存的時候，開頭的 0 會不見：
 * 0912345678 變成 912345678，社工照著打就打不通。
 *
 * 台灣的手機與市話都是 0 開頭，掉了那一位就剛好剩 9 碼
 * （手機 9xxxxxxxx、台北市話 2xxxxxxxx），補回來就對了。
 * 只補這個長度 —— 其他長度亂補，會變成看起來正常但其實打不通的號碼，
 * 比明顯少一位更難發現。
 */
export function restoreLeadingZero(digits) {
